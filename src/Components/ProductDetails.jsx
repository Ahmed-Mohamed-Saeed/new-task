            ...
            <div className="col-lg-6">
              <div className="box">
                ...
                <div className="rate d-flex align-items-center gap-5 my-3">
                  ...
                  <div>
                    <span className="fw-bold">{"4.9"} of 5</span>
                  </div>
                ...
                <div className="quantitiy">
                  ...
                  <button className="bg-light p-2 fw-bold rounded-pill w-50 border position-relative">
                    {count}
                    <span
                      className="position-absolute top-50 start-0 translate-middle-y ms-2 d-flex justify-content-center fs-3 fw-bold rounded-circle"
                      onClick={() => this.props.handle_decrease_count(id)}
                    >
                      -
                    </span>
                    <span
                      className="position-absolute top-50 end-0 translate-middle-y me-2 d-flex justify-content-center fs-3 fw-bold rounded-circle"
